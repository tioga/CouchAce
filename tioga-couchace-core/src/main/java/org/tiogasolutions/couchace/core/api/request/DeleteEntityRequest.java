...
public class DeleteEntityRequest implements DeleteRequest {
    ...
    public DeleteEntityRequest(RequestExecutor requestExecutor, Object entity) {
    ...
    public DeleteEntityRequest onResponse(CouchResponseHandler<WriteResponse> onResponse) {
        this.onResponse = onResponse;
        return this;
    }

    public DeleteEntityRequest onSuccess(CouchResponseHandler<WriteResponse> onSuccess) {
        this.onSuccess = onSuccess;
        return this;
    }

    public DeleteEntityRequest onError(CouchResponseHandler<WriteResponse> onError) {
