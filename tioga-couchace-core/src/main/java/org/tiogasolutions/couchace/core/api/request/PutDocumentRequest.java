...
public class PutDocumentRequest implements PutRequest {
    ...
    public PutDocumentRequest(RequestExecutor requestExecutor, String documentId, String document, String documentRevision) {
    ...
    public PutDocumentRequest onResponse(CouchResponseHandler<WriteResponse> onResponse) {
        this.onResponse = onResponse;
        return this;
    }

    public PutDocumentRequest onSuccess(CouchResponseHandler<WriteResponse> onSuccess) {
        this.onSuccess = onSuccess;
        return this;
    }

    public PutDocumentRequest onError(CouchResponseHandler<WriteResponse> onError) {
